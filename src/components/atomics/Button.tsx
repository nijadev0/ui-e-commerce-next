  ...
  return (
    <button
      ...
      className={`Button ${
        ...
        (size === 'lg' && 'Size-Large gap-3 rounded-lg-10 p-4 text-base') ||
        (size === 'md' && 'Size-Medium gap-2.5 rounded-lg-10 p-3 text-base') ||
        (size === 'sm' && 'Size-Small gap-2 rounded-lg p-2 text-sm')
      } relative flex items-center justify-center border font-semibold leading-none outline-none ring-2 ring-transparent transition-all duration-300 ease-out [&>svg]:flex-shrink-0 ${className}`}
